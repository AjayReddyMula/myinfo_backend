"""
Django settings for django_myinfo project.
...
PROJECT_DIR = ROOT_DIR.path("myinfo_backend")
APPS_DIR = ROOT_DIR.path("myinfo_backend")
...
ROOT_URLCONF = 'myinfo_backend.urls'
...
WSGI_APPLICATION = 'myinfo_backend.wsgi.application'
...
MYINFO_PRIVATE_KEY_SIG = env("MYINFO_PRIVATE_KEY_SIG")

MYINFO_PRIVATE_KEY_ENC = env("MYINFO_PRIVATE_KEY_ENC")
